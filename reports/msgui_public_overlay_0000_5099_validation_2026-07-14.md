...
> 역사 기록: 이 문서는 출시 차단 QA 전 overlay `F6617744...`의 결과다. 현재 안정
> 기준은 `msgui_translation_qa_gate_2026-07-14.md`의 v0.1 `65994E73...`이며,
> 비대칭 슬롯 후속 후보는 `workstreams/msgui_full/asymmetric_v02/`의 v0.2
> `5DC3C0E1...`이다. 아래의 `미번역 0`은 공백 no-op 정규화 전 수치이므로 현재 상태로
> 인용하지 않는다.
