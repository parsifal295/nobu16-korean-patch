...
patcher = load_module("v0150_optional_dlc_patcher_test", "tools/v0150_resource_patcher.py")
release = load_module(
    "v0150_optional_dlc_release_test", "tools/build_v0150_resource_patcher_release.py"
)


class V0150OptionalDlcReleaseTests(unittest.TestCase):
    ...
    def test_release_manifest_declares_optional_dlc_policy(self) -> None:
        ...
        self.assertEqual(
            ...
            "pristine-steam-jp-1.1.7-to-v0.15.0-direct-unified-patcher",
        )
