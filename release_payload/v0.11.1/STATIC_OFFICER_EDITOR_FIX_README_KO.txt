NOBU16 PK Steam JP 1.1.7 v0.11.1
무장 에디트 한글 성명 검증 — 영구 정적 EXE 패치

v0.11.1 설치기 핫픽스
- 게임 폴더 경로 끝의 `\`가 PowerShell 인자에 잘못 전달되어 설치가 실패하던
  문제를 적용/복구 배치 파일 모두에서 수정했습니다.
- Windows PowerShell 5.1에서 설치 오류 한글이 깨져 보이던 스크립트 인코딩도
  수정했습니다.
