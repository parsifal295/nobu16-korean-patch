NOBU16 PK Steam JP 1.1.7 v0.11.5
한글 성명 검증 — 영구 정적 EXE 패치

이 ZIP에는 NOBU16PK.exe가 들어 있지 않습니다. 사용자의 Steam JP 1.1.7
원본 EXE를 PC 안에서 한 번 언팩하고, 검증된 아홉 지점을 수정한 뒤 영구
교체합니다. 이미 v0.11.0~v0.11.4의 무장 에디트 패치가 적용된 EXE는
가공 히메 작명 수정 네 곳만 추가하여 최신 패치본으로 업그레이드합니다.
...
설치기는 원본/기존 패치 EXE 해시, Steamless 언팩 결과, 아홉 개 패치 전
