#!/usr/bin/env python3
"""Build the public Steam JP 1.1.7 v0.11.4 release from pinned inputs.

The archive layout, installer support payload, and safety gates are inherited
from the audited v0.11.2 builder.  This wrapper advances the v0.11.3 release
profile with the Wave15/16 text-quality resources and the Issue #61 policy
effect percent-literal recovery.
"""
...
VERSION = "v0.11.4"
ZIP_NAME = "NOBU16_PK_Korean_Patch_Steam_1.1.7_v0.11.4.zip"
ZIP_TIMESTAMP = (2026, 7, 18, 20, 0, 0)
SCHEMA = "nobu16.kr.steam-jp-1.1.7-release.v0.11.4"
MANIFEST_NAME = "release_manifest.v0.11.4.json"
...
# Current Steam profile after the Wave15/16 text-quality transaction and
# Issue #61.  Five text resources differ from the v0.11.3 profile; the other
# ten game resources and all static-installer support files remain unchanged.
GAME_TARGETS: Mapping[str, tuple[int, str]] = {
    ...
    "MSG/JP/msggame.bin": (1_504_655, "EEA622999F38C72F2088467E04D4A885B684D3FD3CF99FB72879A72079CF9351"),
    ...
    "MSG_PK/JP/msgev.bin": (994_711, "CE1A61E6C0F85A3E7F0FD4C1DD1BF0349A99CC134A9D73B7DE1917DB6646A0C3"),
    "MSG_PK/JP/msggame.bin": (1_806_759, "9EB0FD80E7A6D50BC2A6073FDBF213E7BDB685D81DFCD9191C9C86E415D7EFCC"),
