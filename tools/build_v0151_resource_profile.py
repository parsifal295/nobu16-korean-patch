#!/usr/bin/env python3
"""Build the hash-only v0.15.1 direct-patcher resource profile."""
...
V0140 = load_module("v0140_resource_patcher_for_v0151_profile", V0140_PATCHER)
...
def build_profile(
    ...
    return {
        "schema": "nobu16.kr.resource-profile.v0.15.1",
        "version": "v0.15.1",
