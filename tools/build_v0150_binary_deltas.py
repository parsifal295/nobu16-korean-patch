#!/usr/bin/env python3
"""Build and verify every v0.15.0 BSDIFF40 resource delta."""
...
PATCHER_SOURCE = PROJECT_ROOT / "tools" / "v0150_resource_patcher.py"
...
PATCHER = load_module("v0150_resource_patcher_for_delta_build", PATCHER_SOURCE)
