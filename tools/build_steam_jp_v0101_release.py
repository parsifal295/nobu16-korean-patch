#!/usr/bin/env python3
"""Build the public Steam JP 1.1.7 v0.10.1 release from a pinned live tree."""
...
VERSION: Final = "v0.10.1"
ZIP_NAME: Final = "NOBU16_PK_Korean_Patch_Steam_1.1.7_v0.10.1.zip"
ZIP_TIMESTAMP: Final = (2026, 7, 17, 0, 0, 0)
SCHEMA: Final = "nobu16.kr.steam-jp-1.1.7-release.v0.10.1"
...
def build(game_root: Path, output: Path) -> dict[str, object]:
    ...
    try:
        ...
        (staging / "release_manifest.v0.10.1.json").write_text(
