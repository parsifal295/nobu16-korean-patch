#!/usr/bin/env python3
"""Build the public Steam JP 1.1.7 v0.11.2 release from pinned inputs."""
...
VERSION: Final = "v0.11.2"
ZIP_NAME: Final = "NOBU16_PK_Korean_Patch_Steam_1.1.7_v0.11.2.zip"
ZIP_TIMESTAMP: Final = (2026, 7, 18, 1, 0, 0)
SCHEMA: Final = "nobu16.kr.steam-jp-1.1.7-release.v0.11.2"
MANIFEST_NAME: Final = "release_manifest.v0.11.2.json"
PROJECT_ROOT: Final = Path(__file__).resolve().parents[1]
DEFAULT_PAYLOAD_ROOT: Final = PROJECT_ROOT / "release_payload" / "v0.11.1"

# Full Steam JP resource profile after the Wave5 PC-source dialogue audit.
# The v0.11.1 static-officer-editor support payload is unchanged.
GAME_TARGETS: Final = {
    "MSG/JP/ev_strdata.bin": (928_456, "25D9C029F93788053720C04BAE0C0A14A1A5983F36C68BC2EC7C46C3340D5834"),
    "MSG/JP/msggame.bin": (1_504_667, "32247AB97112243E58F8EB5B2930EE8A8AB9DF6A2FE0907A49AE28A255720610"),
    "MSG/JP/strdata.bin": (957_225, "10AB5E3BD9140B26EB7BC42DC5C352D4CE2905580C6A6112B13B37E12A358AFE"),
    "MSG_PK/JP/msgbre.bin": (484_068, "E3FA61B46E6E08F9FE57A36C1F11C367DD448A9BA63003CA5AB0F2D2BDBBB939"),
    "MSG_PK/JP/msgdata.bin": (497_015, "8B78403C339BEEE655B53A3F63699054DC6D9078640FE717885627E73B529752"),
    "MSG_PK/JP/msgev.bin": (994_707, "134F6356B194AE319125D369A23EBDA11CA8C75FB79EFA7C987D956EDD4CF154"),
    "MSG_PK/JP/msggame.bin": (1_807_237, "51320EE41C17608BC6DD558B35F5243793BBD74168E51BE8C7F7B65E136B330D"),
