...
SUPPORT_TARGETS: Mapping[str, tuple[int, str]] = {
    **_reference.SUPPORT_TARGETS,
    "APPLY_STATIC_OFFICER_EDITOR_FIX.bat": (
        355,
        "5B4859ADB001BE1846A094EBFC49A0BCFE7A12B92B28D04729F995E401FA6635",
    ),
    "RESTORE_ORIGINAL_NOBU16PK_EXE.bat": (
        364,
        "0A4D247EEAF8199124D194CE0838F7B95CE312C41CEB4D31918AA4918AF0C70D",
    ),
    "OfficerEditorStaticFix/Invoke-StaticOfficerEditorFix.ps1": (
        454,
        "7F6A81E5CBCCC41C7892FFFE24D4CFE277BAF18A98FBCEB24787B9A99AA041F1",
    ),
    "STATIC_OFFICER_EDITOR_FIX_README_KO.txt": (
        5_575,
        "CFB48227D0A9F21218E46B05F8CA56E30524EB000A5B9FC3AAC8CE115662E0F3",
    ),
    ...
    "OfficerEditorStaticFix/Invoke-Nobu16StaticPatches.ps1": (
        20_923,
        "4D37561045D834CA5CC1881B2F0D1FD7F3228735325D9B4CA2978DE19E2E2F19",
    ),
    "OfficerEditorStaticFix/000-PatchRegistry.psd1": (
        849,
        "23637E2802E18BE37A8EA492819BD213AD032928E208DFBCAF23893673CF9C76",
    ),
    "OfficerEditorStaticFix/Patches/001-OfficerEditorNameValidation.psd1": (
        671,
        "63250365F02264B974A8916037BE3D05795A5B9B72605EF8625B5533CF647F96",
    ),
    "OfficerEditorStaticFix/Patches/002-FictionalPrincessNameValidation.psd1": (
        565,
        "9CFCD1656022DA48F5185854D5C5EE0BE1BF2A5D90FD2E1930D45A38ED831DDF",
    ),
    "OfficerEditorStaticFix/Patches/003-TopHeaderLayout.psd1": (
        1_322,
        "60F3932617C5486E5FF75A56C48C897C721BDC8677090D51E18587320B356996",
    ),
}
...
def build(
    ...
    *,
    ...
    upstream = load_configured_upstream("steam_jp_v0112_release_for_v0116")
