#!/usr/bin/env python3
"""Build the public Steam JP 1.1.7 v0.11.0 release from pinned inputs."""
...
VERSION: Final = "v0.11.0"
ZIP_NAME: Final = "NOBU16_PK_Korean_Patch_Steam_1.1.7_v0.11.0.zip"
ZIP_TIMESTAMP: Final = (2026, 7, 18, 0, 0, 0)
SCHEMA: Final = "nobu16.kr.steam-jp-1.1.7-release.v0.11.0"
MANIFEST_NAME: Final = "release_manifest.v0.11.0.json"
PROJECT_ROOT: Final = Path(__file__).resolve().parents[1]
DEFAULT_PAYLOAD_ROOT: Final = PROJECT_ROOT / "release_payload" / "v0.11.0"
...
SUPPORT_TARGETS: Final = {
    "APPLY_STATIC_OFFICER_EDITOR_FIX.bat": (
        357,
        "2F412713D83BAD9E0093677EC086B3A43066909BCC686CE4626DC2BADF6D2788",
    ),
    "OfficerEditorStaticFix/Invoke-StaticOfficerEditorFix.ps1": (
        12_029,
        "D2BC594D5D6AD4DF16EA7C452B9A00E18D762F056680BE9CA88650099106FE3C",
    ),
    "OfficerEditorStaticFix/Steamless/Plugins/Steamless.API.dll": (
        34_304,
    ...
    "RESTORE_ORIGINAL_NOBU16PK_EXE.bat": (
        366,
        "821ED263B3E4C4514DB019B8C0193FC901E92EAB3E9EDEBDE9E8E3CE9D642CAE",
    ),
    "STATIC_OFFICER_EDITOR_FIX_README_KO.txt": (
        2_904,
        "1C58F4B5105CA02594FB6B0DEBE0AE73C67A6D8A7FCC8C195AC205B33BCC54FD",
    ),
}
