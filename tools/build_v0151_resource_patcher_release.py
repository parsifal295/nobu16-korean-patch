#!/usr/bin/env python3
"""Build the compact v0.15.1 Steam JP direct unified-patcher hotfix ZIP.
...
VERSION: Final = "v0.15.1"
ZIP_NAME: Final = "NOBU16_PK_Korean_Patch_Steam_1.1.7_v0.15.1.zip"
MANIFEST_NAME: Final = "release_manifest.v0.15.1.json"
LEDGER_MEMBER: Final = "patches/v0.15.1-direct-resource-patch.json.gz"
PATCHER_MEMBER: Final = "NOBU16_KR_RESOURCE_PATCHER.exe"
PROFILE_MEMBER: Final = "v0.15.1-resource-profile.json"
ZIP_TIMESTAMP: Final = (2026, 7, 22, 23, 0, 0)
SCHEMA: Final = "nobu16.kr.steam-jp-direct-resource-patcher.v0.15.1"
...
PATCHER_SOURCE: Final = PROJECT_ROOT / "tools" / "v0151_resource_patcher.py"
...
PATCHER = load_module("v0151_resource_patcher_release", PATCHER_SOURCE)
...
def manifest_for(members: Mapping[str, bytes], ledger: Mapping[str, Any]) -> dict[str, object]:
    ...
    return {
        ...
        "distribution": {
            "kind": "pristine-steam-jp-1.1.7-to-v0.15.1-direct-unified-patcher",
        ...
        "resource_patcher": {
            ...
            "backup_directory": "KR_PATCH_BACKUP/v0.15.1-direct-patcher",
