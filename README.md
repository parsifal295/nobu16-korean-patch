...
| Font-v6 | MSGUI v0.2 + 장수명 + 대사 v0.1 28개 + 성 이름 392개의 700자 수요를 오프라인 A/B 빌드와 공개 레시피 재생으로 검증 | 런타임 화면·종료 QA. 대사 v0.2·v0.3의 193개는 아직 미포함 |
...
2. 장수명·대사 v0.1·v0.2·v0.3의 `msgev` 변경도 ID 오름차순으로 다시 병합한다.
3. 후속 대사 193개의 새 한글 수요를 다음 글꼴 리비전에 넣고 네 글꼴 표 누락 0개를
   재검증한다.
