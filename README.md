...
파싱이 끝난 10개 메시지 리소스 기준 **번역 완료 16,674 / 111,422 (15.0%)**, 초벌 커버리지는 **16,674개**다.
...
| Font-v6 | MSGUI v0.2 + 장수명 + 대사 v0.1 28개 + 성 이름 v0.1 392개의 700자 수요를 오프라인 A/B 빌드와 공개 레시피 재생으로 검증 | 최신 글리프 갱신과 런타임 화면·종료 QA. 성 이름 v0.2 교정분, 대사 v0.2~v0.16 1,861개, 장수 열전 566개, 본편 장수명 2,207개, 본편 이벤트 라벨 365개, `msggame` 1,050개, 옛 지방명 72개, 소형 테이블 130개는 아직 미포함 |
...
4. 후속 대사 1,861개, 장수 열전 566개, 본편 장수명 2,207개, 본편 이벤트 라벨 365개, `msggame` 1,050개, 옛 지방명 72개, 소형 테이블 130개의 새 한글 수요를 다음 글꼴
