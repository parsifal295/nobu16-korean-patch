...
Steam 설치본에는 적용했습니다. 글꼴 복원·이벤트 리베이스 뒤 해당 이벤트 화면 QA는 다시 하지 않았으며, GitHub 릴리스는 공개했습니다. 상태는 설치=True, 화면 QA=NOT_RERUN_AFTER_FONT_ROLLBACK_AND_EVENT_REBASE, 배포=True입니다.
