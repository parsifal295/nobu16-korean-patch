...
파싱이 끝난 8개 메시지 리소스 기준 **번역 완료 13,346 / 83,201 (16.0%)**, 초벌 커버리지는 **13,346개**다.
...
2. 장수명·대사 v0.1~v0.9의 `msgev` 변경과 장수 열전 v0.1~v0.3의 `msgbre` 변경을 각 순정
   기준 레시피로 병합한다.
3. 후속 대사 913개, 장수 열전 458개, 본편 장수명 1,350개, 옛 지방명 72개, 소형 테이블 130개의 새 한글 수요를 다음 글꼴
