# `ev_strdata` 장수명 Batch 8 v0.8

- 리소스: `MSG/SC/ev_strdata.bin`
- 범위: ID `1350`–`1549`
- 번역 수: 연속 표시 문자열 `200`개
- 누적 범위: ID `0`–`1549`, `1550`개
- 다음 시작 ID: `1550`
...
- `public/ev_strdata_ko_officer_names_1350_1549.v0.8.json`
- `evidence/alignment_evidence.v0.8.json`
- `review/review_index.v0.8.json`
- `validation.v0.8.json`
- `build_ev_strdata_batch8.py`
- `tests/test_ev_strdata_batch8.py`
- `BATCH8_V0.8_README_KO.md`

## 재생성

```powershell
python -B workstreams/ev_strdata/build_ev_strdata_batch8.py `
  --game-root .. `
  --out-root workstreams/ev_strdata

python -B -m unittest workstreams.ev_strdata.tests.test_ev_strdata_batch8
```
