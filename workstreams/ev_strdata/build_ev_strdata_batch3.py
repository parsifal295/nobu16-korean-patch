#!/usr/bin/env python3
"""Build source-free MSG/SC/ev_strdata officer-name batch3 artifacts."""
...
BATCH_ID = "ev-strdata-officer-names-0350-0549-v0.3"
OVERLAY_NAME = "ev_strdata_ko_officer_names_0350_0549.v0.3.json"
...
def build_once(game_root: Path, out_root: Path) -> dict[str, Any]:
    ...
    evidence = {
        "schema": "nobu16.kr.ev-strdata-alignment-evidence.v3",
        "batch_id": BATCH_ID,
        "resource": "ev_strdata",
        "scope": {
    ...
    review = {
        "schema": "nobu16.kr.ev-strdata-review-index.v3",
        "batch_id": BATCH_ID,
    ...
    validation = {
        "schema": "nobu16.kr.ev-strdata-generation-validation.v3",
        "batch_id": BATCH_ID,
        "passed": True,
        "scope": {
            "start_id": SCOPE_START,
...
def build_reproducibly(game_root: Path, out_root: Path) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="nobu16-evstr3-a-") as first_tmp:
        with tempfile.TemporaryDirectory(prefix="nobu16-evstr3-b-") as second_tmp:
