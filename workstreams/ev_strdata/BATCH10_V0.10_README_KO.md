# `ev_strdata` 장수명 Batch 10 v0.10

- 리소스: `MSG/SC/ev_strdata.bin`
- 범위: ID `1750`~`1949`
- 번역 및 연속 표시 문자열: `200`개
- 누적 범위: ID `0`~`1949`, `1,950`개
- 다음 시작 ID: `1950`
...
- `public/ev_strdata_ko_officer_names_1750_1949.v0.10.json`
- `evidence/alignment_evidence.v0.10.json`
- `review/review_index.v0.10.json`
- `validation.v0.10.json`
- `build_ev_strdata_batch10.py`
- `tests/test_ev_strdata_batch10.py`
- `BATCH10_V0.10_README_KO.md`

## 재생성

```powershell
python -B workstreams/ev_strdata/build_ev_strdata_batch10.py `
  --game-root .. `
  --out-root workstreams/ev_strdata

python -B -m unittest workstreams.ev_strdata.tests.test_ev_strdata_batch10
```
