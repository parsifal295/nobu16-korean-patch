#!/usr/bin/env python3
"""Build source-free MSG/SC/ev_strdata officer-name batch6 artifacts."""
...
BATCH_ID = "ev-strdata-officer-names-0950-1149-v0.6"
OVERLAY_NAME = "ev_strdata_ko_officer_names_0950_1149.v0.6.json"
...
MANUAL_TRANSLATIONS = {
    1096: {
        "source_sc_utf16le_sha256": (
            "1355AF47D0CBF8FB1612286CA508EA1B2E25460E41C7DB3F2A2F1613BA14EA5F"
        ),
        "ko": "쇼니 스케모토",
    },
    1097: {
        "source_sc_utf16le_sha256": (
            "AFD80040792EF271771F3360A4230794C2F77AC7C8378BC64A17E767848550B7"
        ),
        "ko": "쇼니 후유히사",
    },
}
...
def load_translations(sc_table: Any) -> dict[int, str]:
    """Reuse exact name hashes and independently pin the two source variants."""
...
def configured_engine() -> Iterator[None]:
    """Run the reviewed v0.4 mechanics with only v0.6 batch constants changed."""
...
def upgrade_v06_metadata(out_root: Path) -> None:
    ...
    evidence["schema"] = "nobu16.kr.ev-strdata-alignment-evidence.v6"
    ...
    review["schema"] = "nobu16.kr.ev-strdata-review-index.v6"
    ...
    validation["schema"] = "nobu16.kr.ev-strdata-generation-validation.v6"
    safety = validation["safety"]
    safety.pop("existing_v01_v02_v03_artifacts_modified", None)
    safety["existing_v01_v02_v03_v04_v05_artifacts_modified"] = False
    ...
    if any(
        ...
        raise shared.EvStrDataError(
            "v0.6 public artifact contains source script text or an embedded NUL"
        )
...
def build_reproducibly(game_root: Path, out_root: Path) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="nobu16-evstr6-a-") as first_tmp:
        with tempfile.TemporaryDirectory(prefix="nobu16-evstr6-b-") as second_tmp:
