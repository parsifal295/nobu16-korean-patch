...
import build_event_dialogue_batch9 as batch  # noqa: E402


EXPECTED_HASHES = {
    f"public/{batch.OVERLAY_NAME}": (
        "C5781DC398C09C776888577F3831F9C853440C5A1A0C0BC450384E4505911F9A"
    ),
    f"evidence/{batch.EVIDENCE_NAME}": (
        "DFEAC5B69599C239A02E5A3C1801382312691A51FF6F9A4E3F7D8D207C9426D6"
    ),
    f"review/{batch.REVIEW_NAME}": (
        "42E2DA83B1391451A55B14AD06F6407D1A4F8C705B783257DD02F39A12ABEA08"
    ),
    batch.VALIDATION_NAME: (
        "0F23B1D2B02985CDCB5E2F674630CEC250977EC830A1EC1D683364723FE97C1C"
    ),
}
...
class EventDialogueBatch9Tests(unittest.TestCase):
    @classmethod
    ...
    def test_scope_is_exactly_129_displayed_entries(self) -> None:
        ...
        self.assertEqual(list(range(4032, 4161)), selected)
        ...
        self.assertEqual(129, sum(int(event["selected_count"]) for event in batch.EVENTS))
