...
import build_event_dialogue_batch5 as batch  # noqa: E402


EXPECTED_HASHES = {
    f"public/{batch.OVERLAY_NAME}": (
        "1E5D5E874439C7D0FC0BD93D6EB2FBAC6C249DF18A9BFBCBBE2200BCC45F75AC"
    ),
    f"evidence/{batch.EVIDENCE_NAME}": (
        "0D561160DBDA0CACC38DCA729A5B315603ED75B9DC94889C5B0A4DBF900AE085"
    ),
    f"review/{batch.REVIEW_NAME}": (
        "582C7F2930496F36CA460370DD3CA47C611F4794C8DFD7A6EA1028008D921C20"
    ),
    batch.VALIDATION_NAME: (
        "F6AE6830D94549DB9D917D2F65DAE0A8BDAA59A956A10ECE17428B4BA565203A"
    ),
}
...
class EventDialogueBatch5Tests(unittest.TestCase):
    @classmethod
    ...
    def test_scope_is_exactly_124_displayed_entries(self) -> None:
        ...
        self.assertEqual(list(range(3565, 3689)), selected)
    ...
    def test_validation_records_invariants_reproducibility_and_safety(self) -> None:
        ...
        self.assertFalse(safety["existing_v01_v02_v03_v04_artifacts_modified"])
