...
CANDIDATES: tuple[Candidate, ...] = (
    ...
    Candidate("base", 5155, "374A02A025D89355A2DCFF3ECE0D1B9708510DFAB0BC8E9E4D59ACD70BD95F22", "851EDF64F9D1E6CF3DE9F0D59D30584D303E8C673B5CAAE70C435EF4CB1704BC", "wording_change_with_layout", "성을 딸려 한베에를 거두려는 목적 관계를 보존하고 조사 분절을 제거한다.", _text("아버지 대부터 <E>CB사이토 가문<E>CZ에 시달린\n<E>CA오다 노부나가<E>CZ 등은 <E>CC미노 반국<E>CZ을 내주고\n성째로 <E>CA한베에<E>CZ를 들이자고 제안했으나…")),
    ...
    Candidate("base", 6233, "C5248EE9720A7D1E39AC8DE492D9A0C5CB0AD2220946219579AFB81D47EC6334", "3D809CFDBE6081D52286F5CA0426FF7A3236BBB9177C9AD5A2DF1FEE408F150C", "wording_change_with_layout", "흰 원 셋을 나란히 둔 깃발 문양의 핵심 도상을 보존한다.", _text("주인의 따뜻한 대접에 감동한 <E>CA다카토라<E>CZ는\n흰 원 셋을 나란히 둔 ‘흰 떡 셋’을\n이후 깃발 문양으로 삼았다고 한다…")),
    ...
    Candidate("pk", 6499, "C0A8BE3AB625CCF0A148DB951231089090F1306083F2FB05B437882E171C162A", "C8C10722B89BCADE15F1CC2930A408433077A31D511D27C0E315A99E0E697FB6", "wording_change_with_layout", "赤備え를 프로젝트 용어인 적비 부대로 바로잡고 편제명을 한 줄에 유지한다.", _text("<E>CB다케다군<E>CZ 최강의 적비 부대—\n<E>CA야마가타 마사카게<E>CZ의 싸움은\n이 <E>CC나가시노<E>CZ에서 막을 내렸다.")),
