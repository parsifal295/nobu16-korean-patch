#!/usr/bin/env python3
"""Private tests for the PC event manual_compact Static Patch 007 batch 04."""
...
BUILDER_PATH = SCRIPT.with_name("build_pc_event_manual_compact_static007_batch04_v1.py")
SPEC = importlib.util.spec_from_file_location("manual_compact_static007_batch04", BUILDER_PATH)
...
class ManualCompactStatic007Batch04Tests(unittest.TestCase):
    ...
    def test_strict_batch03_context_and_exact_diff(self) -> None:
        ...
        self.assertNotEqual(before.texts[3285], builder.TARGETS[3285])
        ...
        self.assertEqual(len(bundle.audit["exact_two_row_diff"]), 1)
