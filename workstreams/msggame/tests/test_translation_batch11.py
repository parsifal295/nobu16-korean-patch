...
import build_translation_batch11 as batch  # noqa: E402
from build_literal_overlay import apply_overlay_blob  # noqa: E402


EXPECTED_HASHES = {
    f"public/{batch.OVERLAY_NAME}": (
        "7E697120390C9F5C2916EE4343482558AF72FA422F7AF531129BB5E2DECC8DAC"
    ),
    f"evidence/{batch.EVIDENCE_NAME}": (
        "C39796F7BB3EC499E57B649F342B27233A3CF641ABA35D7F622F963271F709A8"
    ),
    f"review/{batch.REVIEW_NAME}": (
        "BA30D55F4320AC8E78F2CC3B745AD6E81181DDF63E0530E1DECA22D7581BB82C"
    ),
    batch.VALIDATION_NAME: (
        "3F54FA2C7B46D13780C20C26A841E1F72A0DD96E870842020941B2F546D98762"
    ),
}
EXPECTED_TARGET_SHA256 = (
    "78FEF9C0168A914D405A15311FDF0410C952C2CCFBBC1A4D9A28D77010E8404D"
)
PRIOR_OVERLAYS = (
...
class MsggameTranslationBatch11Tests(unittest.TestCase):
    @classmethod
    ...
    def test_scope_is_exactly_150_linguistic_literals(self) -> None:
        ...
        self.assertEqual(77, len(batch.selected_record_keys()))
        self.assertEqual((6, 1515, 0), coordinates[0])
        self.assertEqual((6, 1677, 0), coordinates[-1])
        self.assertEqual((6, 1677, 1), batch.NEXT_COORDINATE)
    ...
    def test_alignment_records_context_without_source_text(self) -> None:
        self.assertEqual(77, self.evidence["record_count"])
        self.assertEqual(77, len(self.evidence["records"]))
        differing_shapes = 0
