...
import build_base_translation_batch1 as batch  # noqa: E402
import build_translation_batch18 as pk_batch18  # noqa: E402
from build_literal_overlay import apply_overlay_blob  # noqa: E402


EXPECTED_HASHES = {
    f"public/{batch.OVERLAY_NAME}": "0723B420255CB72C915701E0311941E09392E2A4691580C02E59C9DD9F4CB8AD",
    f"evidence/{batch.EVIDENCE_NAME}": "0F4BF55791F4D102797B1A6968D29297871E84D15798185C397D6FE0C23AE8C6",
    f"review/{batch.REVIEW_NAME}": "B012EF2E212E41917873395C531DC2E4296EE77CC20E3E1CC7E9507F44997535",
    batch.VALIDATION_NAME: "631B7D762DCEC76A8157C4797FA2FB86B1ADC7CF267A89C3D7D8C5A2F33883DF",
}
EXPECTED_TARGET_SHA256 = "F2F491247BB1695B1DAD40AB66D5A8DAF75BCB1240F0BA9C41CE927B25EA5B31"
...
class BaseMsggameTranslationBatch1Tests(unittest.TestCase):
    @classmethod
    ...
    def test_scope_is_exactly_the_first_150_visible_base_sc_literals(self) -> None:
        coordinates = batch.selected_coordinates()
        self.assertEqual(150, len(coordinates))
        self.assertEqual(131, len(batch.selected_record_keys()))
        self.assertEqual((0, 1194, 0), coordinates[0])
        self.assertEqual((2, 138, 1), coordinates[-1])
        self.assertEqual((2, 139, 0), batch.NEXT_COORDINATE)
        ...
        self.assertEqual(coordinates, selected[:150])
        self.assertEqual(batch.NEXT_COORDINATE, selected[150])

    def test_base_scope_is_separate_from_pk_module_state(self) -> None:
    ...
    def test_published_artifacts_are_source_free_and_base_pinned(self) -> None:
        ...
        self.assertEqual(131, self.evidence["record_count"])
