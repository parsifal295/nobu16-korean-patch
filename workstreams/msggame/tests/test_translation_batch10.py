...
import build_translation_batch10 as batch  # noqa: E402
from build_literal_overlay import apply_overlay_blob  # noqa: E402


EXPECTED_HASHES = {
    f"public/{batch.OVERLAY_NAME}": (
        "1230CC67D68726390FBD6677FC980603D5EF17F7CF8318525E03EC03EAA4E1FF"
    ),
    f"evidence/{batch.EVIDENCE_NAME}": (
        "75313108C6150B26ED1A07F65A8DA1A973F7986DD3EE77176832519A4AA2F480"
    ),
    f"review/{batch.REVIEW_NAME}": (
        "1A0166CDBDCBF1FFD923F45511BC9D0D4CDC0599367C46E4BDAC12A6167C4C9E"
    ),
    batch.VALIDATION_NAME: (
        "0971C70127734C556C57FD5FF9E9E2E5EACA3513E42E6C70D51FACF78F164CC8"
    ),
}
EXPECTED_TARGET_SHA256 = (
    "334788796C3B30A1811EF11EDB410484EE8EFDB09514F343B884EDAD3EF57036"
)
PRIOR_OVERLAYS = (
...
class MsggameTranslationBatch10Tests(unittest.TestCase):
    @classmethod
    ...
    def test_scope_is_exactly_150_linguistic_literals(self) -> None:
        ...
        self.assertEqual((6, 1385, 0), coordinates[0])
        self.assertEqual((6, 1514, 1), coordinates[-1])
        self.assertEqual((6, 1515, 0), batch.NEXT_COORDINATE)
