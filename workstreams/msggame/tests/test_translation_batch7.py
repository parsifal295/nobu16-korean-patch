...
import build_translation_batch7 as batch  # noqa: E402
from build_literal_overlay import apply_overlay_blob  # noqa: E402


EXPECTED_HASHES = {
    f"public/{batch.OVERLAY_NAME}": (
        "EB328E39DBC811BA258178C02AAB1C76795CCCB385A285072C9A20944AE94E65"
    ),
    f"evidence/{batch.EVIDENCE_NAME}": (
        "1101834764FD3FE97481FCE36622406466E1DABAC4BC37F2FD157A0276F0A842"
    ),
    f"review/{batch.REVIEW_NAME}": (
        "FEE1233E90AD8C1707078D6E83E9F71963976C6B5D5E5041866551BD95372C77"
    ),
    batch.VALIDATION_NAME: (
        "3A354DB64A2C59CA1111F6DCB389786E8846752DAD6285DE28F249F21616D88D"
    ),
}
EXPECTED_TARGET_SHA256 = (
    "49147F4CBA624373158DAA4BD8B9BE0966275DD006CE3A99FA3244DED3868AD3"
)
PRIOR_OVERLAYS = (
...
class MsggameTranslationBatch7Tests(unittest.TestCase):
    @classmethod
    ...
    def test_scope_is_exactly_150_linguistic_literals(self) -> None:
        ...
        self.assertEqual((6, 560, 0), coordinates[0])
        self.assertEqual((6, 947, 0), coordinates[-1])
        self.assertEqual((6, 948, 0), batch.NEXT_COORDINATE)
