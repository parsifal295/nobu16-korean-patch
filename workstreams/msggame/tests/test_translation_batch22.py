...
import build_translation_batch21 as batch21  # noqa: E402
import build_translation_batch22 as batch  # noqa: E402
from build_literal_overlay import apply_overlay_blob  # noqa: E402


EXPECTED_HASHES = {
    f"public/{batch.OVERLAY_NAME}": "8BF5B5C58D6CC522775B379A942ED9B67AA94C97409CD68C47B25F805310ED8B",
    f"evidence/{batch.EVIDENCE_NAME}": "873E2C91659D4B9D9A0DD6CFC74AFEEF5DD3395CE80EA1C02447C5DB7795EE93",
    f"review/{batch.REVIEW_NAME}": "892DE343224D72911B993F5E1084D132C019C64A6D5DAC213A950D2FBECAAEF5",
    batch.VALIDATION_NAME: "F57528D40C6F4863C1600FC77146D52E92284380F2CA706350D1B79EF866013C",
}
EXPECTED_TARGET_SHA256 = "2556480A9210AA1445CD8BCD19940732B0C9A9F721B4F172FC0F8E1CECCC6792"
PRIOR_OVERLAYS = (
    ...
    "msggame_ko_system_messages_b06r3698_3837.v0.21.json",
)
...
class MsggameTranslationBatch22Tests(unittest.TestCase):
    @classmethod
    ...
    def test_scope_is_exactly_the_next_150_visible_sc_literals(self) -> None:
        ...
        self.assertEqual(89, len(batch.selected_record_keys()))
        self.assertEqual((6, 3841, 0), coordinates[0])
        self.assertEqual((6, 3930, 0), coordinates[-1])
        self.assertEqual((6, 3930, 1), batch.NEXT_COORDINATE)
        self.assertEqual(("에", None, None), batch.TRANSLATIONS[(6, 3930)])
    ...
    def test_batch21_boundary_is_preserved_and_private_engine_is_isolated(self) -> None:
        self.assertEqual((6, 3698, 0), batch21.selected_coordinates()[0])
        self.assertEqual((6, 3837, 0), batch21.selected_coordinates()[-1])
        self.assertEqual((6, 3841, 0), batch21.NEXT_COORDINATE)
        self.assertFalse(batch.previous.is_visible_translation_candidate(""))
        self.assertIsNot(batch._engine, batch21._engine)
    ...
    def test_published_artifacts_are_source_free_and_pinned(self) -> None:
        ...
        self.assertEqual(89, self.evidence["record_count"])
