...
DEFAULT_PRIVATE_OUTPUT = (
    TMP / "pk_dialogue_wave_assignment.post_selector292_wave2.private.v1.json"
)
DEFAULT_PUBLIC_OUTPUT = (
    PUBLIC / "pk_dialogue_wave_assignment.post_wave1.source_free.v1.json"
)
PACKET_DIR = TMP / "pk_dialogue_wave_post_selector292_v2"
...
METHOD = (
    "post_selector292_wave1_rank_order_greedy_three_way_"
    "root_terminal_and_atomic_independent_assignment"
)
WAVE_ID = "post_selector292_wave2"
MAX_SELECTORS = 3
...
EXPECTED_SELECTED_SELECTORS: tuple[int, ...] | None = (1048, 82, 214)
EXPECTED_SELECTION_RANKS: tuple[int, ...] | None = (1, 2, 3)
EXPECTED_SELECTION_PROFILE_SHA256: str | None = (
    "01077D611A5C05FCC71491AC60200AEC2B8CAFCD27F12B8EE032FB7159ED816D"
)
EXPECTED_PACKET_SHA256: tuple[str, ...] | None = (
    "DFF4EDC89C53D12A6F9FFFD641825D101D26BB48A3BC40D8D2A3D57D612E624C",
    "CA3C7C6F617631586E4BC3DA2B65F0FA8301746532FD5D76D1122650EB71FC3C",
    "E75D5A10BD7230D763AC1C80BAC1D86DD85D49AD54F54FE92489599F4CFC14CE",
)
...
def load_world(wrapper: Any) -> dict[str, Any]:
    ...
    require(
        ...
        "post-wave1 candidate reconstruction drifted",
    )
    ledger = {
...
def build_packet(
    ...
    *,
    ...
    decisions_name = (
        f"pk_dialogue_wave2_selector{selector}_decisions.private.v1.jsonl"
    )
    evidence_name = (
        f"pk_dialogue_wave2_selector{selector}_evidence.private.v1.json"
    )
    packet = {
        "agent_contract": {
...
def build_outputs(
    *,
    ...
    require(RANKING_BUILDER_PATH.is_file(), "post-wave1 ranking absent")
    wrapper = load_module(
    ...
    ranking_private, ranking_public, _ranking_inputs = wrapper.build_outputs()
    require(
