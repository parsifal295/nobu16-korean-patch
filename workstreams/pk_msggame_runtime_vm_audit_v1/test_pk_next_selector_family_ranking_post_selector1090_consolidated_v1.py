#!/usr/bin/env python3
"""Focused tests for the immutable post-selector1090 PK ranking."""
...
SPEC = importlib.util.spec_from_file_location("post1090_ranking_test", PATH)
...
class PostSelector1090RankingTests(unittest.TestCase):
    @classmethod
    ...
    def test_exact_universe_and_recommendation(self) -> None:
        ...
        self.assertEqual(
            ...
            ("0:760", 67, 21, 21, 32, 35, 3, 0),
        )
        self.assertEqual(
            self.private["classification_counts"],
            {
                "already_owned_selector_or_dispatch_closure": 15,
                "eligible_fixed_seven_way_selector": 113,
                "non_seven_way_call_target": 25,
            },
        )
        self.assertIn(1090, self.public["exclusions"]["already_owned_selectors"])
