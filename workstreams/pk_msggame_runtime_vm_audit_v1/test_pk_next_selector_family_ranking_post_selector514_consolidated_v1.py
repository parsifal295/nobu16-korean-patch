#!/usr/bin/env python3
"""Focused tests for the immutable post-selector514 PK ranking."""
...
SPEC = importlib.util.spec_from_file_location("post514_ranking_test", PATH)
...
class PostSelector514RankingTests(unittest.TestCase):
    @classmethod
    ...
    def test_exact_universe_and_recommendation(self) -> None:
        ...
        self.assertEqual(
            self.private["classification_counts"],
            {
                ...
                "eligible_fixed_seven_way_selector": 120,
