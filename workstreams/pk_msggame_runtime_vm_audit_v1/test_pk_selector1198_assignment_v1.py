#!/usr/bin/env python3
"""Focused tests for the immutable two-chunk selector-1198 assignment."""
...
PATH = Path(__file__).with_name("build_pk_selector1198_assignment_v1.py")
SPEC = importlib.util.spec_from_file_location("selector1198_assignment_test", PATH)
...
class Selector1198AssignmentTests(unittest.TestCase):
    @classmethod
