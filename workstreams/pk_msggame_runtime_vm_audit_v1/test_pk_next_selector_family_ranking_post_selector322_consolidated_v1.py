#!/usr/bin/env python3
"""Focused tests for the immutable post-selector322 PK ranking."""
...
SPEC = importlib.util.spec_from_file_location("post322_ranking_test", PATH)
...
class PostSelector322RankingTests(unittest.TestCase):
    @classmethod
    ...
    def test_exact_universe_recommendation_and_owned_guard(self) -> None:
        ...
        self.assertEqual(
            ...
            ("0:1162", 55, 23, 23, 61, 66, 5, 0),
        )
        self.assertEqual(
            self.private["classification_counts"],
            {
                "already_owned_selector_or_dispatch_closure": 20,
                "eligible_fixed_seven_way_selector": 107,
