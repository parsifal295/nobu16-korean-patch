#!/usr/bin/env python3
"""Focused tests for the immutable post-selector760 PK ranking."""
...
SPEC = importlib.util.spec_from_file_location("post760_ranking_test", PATH)
...
class PostSelector760RankingTests(unittest.TestCase):
    @classmethod
    ...
    def test_exact_universe_and_recommendation(self) -> None:
        ...
        self.assertEqual(
            ...
            ("0:508", 61, 22, 22, 74, 81, 7, 0),
        )
        self.assertEqual(
            self.private["classification_counts"],
            {
                "already_owned_selector_or_dispatch_closure": 16,
                "eligible_fixed_seven_way_selector": 111,
                "non_seven_way_call_target": 24,
            },
        )
        self.assertIn(760, self.public["exclusions"]["already_owned_selectors"])
