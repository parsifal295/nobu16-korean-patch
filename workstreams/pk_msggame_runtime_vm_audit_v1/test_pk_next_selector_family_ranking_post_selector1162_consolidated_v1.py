#!/usr/bin/env python3
"""Focused tests for the immutable post-selector1162 PK ranking."""
...
SPEC = importlib.util.spec_from_file_location("post1162_ranking_test", PATH)
...
class PostSelector1162RankingTests(unittest.TestCase):
    @classmethod
    ...
    def test_exact_universe_recommendation_and_owned_guard(self) -> None:
        ...
        self.assertEqual(
            ...
            ("0:376", 52, 25, 27, 41, 48, 7, 0),
        )
        self.assertEqual(
            self.private["classification_counts"],
            {
                "already_owned_selector_or_dispatch_closure": 21,
                "eligible_fixed_seven_way_selector": 106,
        ...
        self.assertNotIn("0:1162", ranked)
