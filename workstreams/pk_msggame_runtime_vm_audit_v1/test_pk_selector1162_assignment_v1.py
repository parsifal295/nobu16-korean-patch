#!/usr/bin/env python3
"""Focused tests for the immutable two-chunk selector-1162 assignment."""
...
PATH = Path(__file__).with_name("build_pk_selector1162_assignment_v1.py")
SPEC = importlib.util.spec_from_file_location("selector1162_assignment_test", PATH)
...
class Selector1162AssignmentTests(unittest.TestCase):
    @classmethod
