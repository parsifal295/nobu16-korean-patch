#!/usr/bin/env python3
"""Focused tests for the immutable post-selector508 PK ranking."""
...
SPEC = importlib.util.spec_from_file_location("post508_ranking_test", PATH)
...
class PostSelector508RankingTests(unittest.TestCase):
    @classmethod
    ...
    def test_exact_universe_recommendation_and_owned_guard(self) -> None:
        self.assertEqual(
            (
        ...
        self.assertEqual(
            ...
            ("0:742", 61, 27, 27, 59, 80, 21, 0),
        )
        self.assertEqual(
            self.private["classification_counts"],
            {
                "already_owned_selector_or_dispatch_closure": 17,
                "eligible_fixed_seven_way_selector": 110,
                "non_seven_way_call_target": 24,
            },
        )
        self.assertIn(508, self.public["exclusions"]["already_owned_selectors"])
        self.assertNotIn(
            "0:508",
