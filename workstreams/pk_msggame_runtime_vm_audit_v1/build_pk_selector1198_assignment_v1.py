#!/usr/bin/env python3
"""Build the root-disjoint two-chunk assignment for PK selector 1198."""
...
SELECTOR = 1198
TERMINALS = tuple(range(2672, 2679))
CHUNK_COUNT = 2
PRIVATE_SCHEMA = "nobu16.kr.pk-selector1198-assignment.private.v1"
PUBLIC_SCHEMA = "nobu16.kr.pk-selector1198-assignment-coverage.v1"
METHOD = (
    "selector628_checkpoint_selector1198_root_disjoint_two_chunk_"
    "template_atom_assignment"
)

EXPECTED_INPUT_SHA256 = {
    "ledger": "64F57157C47A72E42CBDBDA59C84AA142519CAAF7D4391983CEFD34362640147",
    "checkpoint_public": "D75600A25C086D41190589DA21C8B389ACD9A9BAD561B920F9BB25F5FB9E5B88",
    "ranking_builder": "5D24BFA592DA2CC2A95C0CB937EBB00C6E70211EC9CB9FF1376EDF135C5CA207",
    "ranking_private": "A6D43C66FFCD82A114AF4C5FC70371E209FC61C56916905F0513946F3655A6BB",
    "ranking_public": "95F0B757ECBB58610415F8FAE0A5CAFAA94083D6950E94E20C549EC3AFC0534C",
...
EXPECTED_COVERAGE = (46, 46, 46, 0, 0, 25, 25, 83)
EXPECTED_SITE_ROW_SHA256: str | None = (
    "0DAEE49DC5CB7A2A8649F224108D8F2AE9683A719221A04BE42CCBA6765489EC"
)
...
RANKING_WRAPPER = load_module(RANKING_BUILDER_PATH, "pk_selector1198_ranking_v1")
RANKING = RANKING_WRAPPER.RANKING
RANKING.CONTROL_RE = RANKING.LEGACY.CONTROL_RE
BASE = load_module(BASE_ASSIGNMENT_PATH, "pk_selector1198_base_assignment_v1")
HELPER = BASE.HELPER
RECORDS = BASE.BASE
...
def build_outputs() -> tuple[str, str, dict[str, Any], dict[str, Any]]:
    ...
    require(
        ranking_public["recommendation"]["selector_coordinate"] == "0:1198",
        "ranking handoff drift",
    )
    target = next(
        row for row in ranking_private["direct_targets"]
        if row["target_coordinate"] == "0:1198"
    )
    ...
    require(
        ...
        f"selector1198 coverage drift: {observed_coverage}",
    )
