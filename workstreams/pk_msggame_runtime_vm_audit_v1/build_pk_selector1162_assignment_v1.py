#!/usr/bin/env python3
"""Build the root-disjoint two-chunk assignment for PK selector 1162."""
...
DEFAULT_PRIVATE_OUTPUT = DIALOGUE_TMP / "pk_selector1162_assignment.private.v1.json"
DEFAULT_PUBLIC_OUTPUT = (
    WORKSTREAM / "public" / "pk_selector1162_assignment_coverage.v1.json"
)

SELECTOR = 1162
TERMINALS = tuple(range(1902, 1909))
PRIVATE_SCHEMA = "nobu16.kr.pk-selector1162-assignment.private.v1"
PUBLIC_SCHEMA = "nobu16.kr.pk-selector1162-assignment-coverage.v1"
METHOD = (
    "selector322_checkpoint_selector1162_root_disjoint_two_chunk_"
    "template_atom_assignment"
)
EXPECTED_INPUT_SHA256 = {
    "ledger": "9A7E135544FA2F2A02A0D2B4941159CB92A3E4A495AF72B6CB335DE371351343",
    "checkpoint_public":
        "3C245CE82733F50F08E61B05A165B1038C4D5BBA5D3DAD38D46933B392101642",
    "ranking_builder":
        "2FB8459D082CAC38C2F203BB98B0860C13D2CE9D32BE1E9CA6786C1608CAC3F3",
    "ranking_private":
...
EXPECTED_COVERAGE = (61, 61, 66, 5, 0, 23, 23, 55)
EXPECTED_SITE_ROW_SHA256: str | None = (
    "1ACC4F517B4495FBB73F8AF6B2DA083521F385891213DE92FCB301CDDA4AFCFC"
)
...
ASSIGNMENT = load_module(BASE_BUILDER_PATH, "pk_selector1162_assignment_base_v1")
RANKING_WRAPPER = load_module(
    RANKING_BUILDER_PATH,
    "pk_selector1162_ranking_v1",
)
...
def build_outputs() -> tuple[str, str, dict[str, Any], dict[str, Any]]:
    ...
    def adapted_loads(value: str, *args: Any, **kwargs: Any) -> Any:
        ...
        if "direct_targets" in result:
            for row in result["direct_targets"]:
                if row.get("target_coordinate") == "0:1162":
                    row["target_coordinate"] = "0:1198"
                    break
        recommendation = result.get("recommendation")
        if (
            isinstance(recommendation, dict)
            and recommendation.get("selector_coordinate") == "0:1162"
        ):
    ...
    private["scope"]["selector_coordinate"] = "0:1162:0"
    public["scope"]["official_pending_rows"] = 6310
