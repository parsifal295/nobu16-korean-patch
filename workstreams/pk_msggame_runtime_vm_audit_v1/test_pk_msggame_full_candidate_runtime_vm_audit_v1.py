...
class PkFullCandidateRuntimeVmTests(unittest.TestCase):
    ...
    def test_full_candidate_scope_and_transitions(self) -> None:
        ...
        self.assertEqual(coverage["scope"]["promotion_eligible_rows"], 7_463)
        self.assertEqual(coverage["scope"]["blocked_rows"], 2_307)
        self.assertEqual(
        ...
        self.assertEqual(transitions["kept_eligible_rows"], 4_669)
        self.assertEqual(transitions["newly_eligible_rows"], 2_794)
        self.assertEqual(transitions["newly_blocked_rows"], 48)
        self.assertEqual(len(self.rows), 7_463)
