#!/usr/bin/env python3
"""Focused tests for the immutable post-selector628 PK ranking."""
...
SPEC = importlib.util.spec_from_file_location("post628_ranking_test", PATH)
...
class PostSelector628RankingTests(unittest.TestCase):
    @classmethod
    ...
    def test_exact_universe_and_recommendation(self) -> None:
        ...
        self.assertEqual(
            ...
            {
                "already_owned_selector_or_dispatch_closure": 11,
                "eligible_fixed_seven_way_selector": 118,
