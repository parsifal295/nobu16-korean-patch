#!/usr/bin/env python3
"""Focused tests for the immutable post-selector742 PK ranking."""
...
SPEC = importlib.util.spec_from_file_location("post742_ranking_test", PATH)
...
class PostSelector742RankingTests(unittest.TestCase):
    @classmethod
    ...
    def test_exact_universe_recommendation_and_owned_guard(self) -> None:
        ...
        self.assertEqual(
            ...
            ("0:322", 57, 29, 29, 85, 94, 9, 0),
        )
        self.assertEqual(
            self.private["classification_counts"],
            {
                "already_owned_selector_or_dispatch_closure": 19,
                "eligible_fixed_seven_way_selector": 109,
