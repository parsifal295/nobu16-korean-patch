#!/usr/bin/env python3
"""Rank remaining PK selector families on the selector-550 checkpoint.

The graph walk is inherited from the frozen post-selector610 ranking
implementation, but every mutable audit constant is rebound to the immutable
selector-550 targeted delta checkpoint. Older ranking artifacts are never read
as current state and are never rewritten.
"""
...
PREDECESSOR_BUILDER = (
    WORKSTREAM
    / "build_pk_next_selector_family_ranking_post_selector610_consolidated_v1.py"
)
DEFAULT_STEAM_ROOT = (
...
DEFAULT_LEDGER = (
    ...
    "post_selector550_consolidated_checkpoint.private.v1.jsonl"
)
CHECKPOINT_PUBLIC = (
    REPO
    / "workstreams"
    ...
    "post_selector550_consolidated_checkpoint.source_free.v1.json"
)
...
PRIVATE_SCHEMA = (
    ...
    "post-selector550-consolidated.private.v1"
)
PUBLIC_SCHEMA = (
    "nobu16.kr.pk-next-selector-family-ranking-"
    "post-selector550-consolidated-source-free.v1"
)
METHOD = (
    "selector550_checkpoint_pending_reachable_0143_"
    "seven_way_selector_ranking"
)
OWNED_SELECTORS = (538, 568, 1096, 1174, 610, 550)
...
EXPECTED_PK_PENDING_ROWS = 6_980
EXPECTED_PK_PENDING_ROOTS = 4_391
EXPECTED_PK_PENDING_ROOT_SHA256 = (
    "EB810AB828C0F0CEB49356E291A0EC1109B7AC92FB3E3803D652E26B7574620B"
)
EXPECTED_REACHABLE_CALL_TARGETS = 160
EXPECTED_OWNED_CALL_TARGETS = 7
EXPECTED_NON_SEVEN_WAY_TARGETS = 26
EXPECTED_ELIGIBLE_FAMILIES = 127
EXPECTED_ELIGIBLE_UNION_ROWS = 1_774
EXPECTED_ELIGIBLE_UNION_SHA256 = (
    "D72ABDA43A4570D79D36B1CA12CD70C81534632A5C6CC286CA9F442BAFBA19EB"
)
EXPECTED_RECOMMENDED_SELECTOR = "0:748"
EXPECTED_RECOMMENDED_TERMINALS = tuple(
    f"0:{record_id}" for record_id in range(2161, 2168)
)
EXPECTED_RECOMMENDED_PENDING_ROWS = 162
EXPECTED_RECOMMENDED_PENDING_ROOTS = 60
EXPECTED_RECOMMENDED_PENDING_SITES = 62
EXPECTED_RECOMMENDED_CANDIDATE_SITES = 102
EXPECTED_RECOMMENDED_SOURCE_SITES = 114
EXPECTED_RECOMMENDED_SOURCE_ONLY_SITES = 12
...
EXPECTED_POINT_ESTIMATE = 127
EXPECTED_ESTIMATE_RANGE = (110, 142)

# Frozen after the first reproducible write/check cycle.
EXPECTED_PRIVATE_FILE_SHA256: str | None = (
    "6DBF0FF82745F8C229656BBDE4F2E94312DE0C2796F3BA080648AAF5F6E984ED"
)
EXPECTED_PUBLIC_FILE_SHA256: str | None = (
    "1F8377BF3FE8296FEFBA563A1555E524C340E155BC1DB50C0C1A92AAF72BEF38"
)
...
PREDECESSOR_WRAPPER = load_module(
    PREDECESSOR_BUILDER,
    "pk_next_selector_post_550_predecessor_helpers_v1",
)
RANKING = PREDECESSOR_WRAPPER.RANKING

# Rebind every stateful input and every assertion affected by selector 550.
for _name in (
    "DEFAULT_STEAM_ROOT",
    "DEFAULT_LEDGER",
    "CHECKPOINT_PUBLIC",
