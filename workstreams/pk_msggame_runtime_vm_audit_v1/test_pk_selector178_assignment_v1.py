#!/usr/bin/env python3
"""Focused tests for the immutable two-chunk selector-178 assignment."""
...
PATH = Path(__file__).with_name("build_pk_selector178_assignment_v1.py")
SPEC = importlib.util.spec_from_file_location("selector178_assignment_test", PATH)
...
class Selector178AssignmentTests(unittest.TestCase):
    @classmethod
