#!/usr/bin/env python3
"""Focused tests for the immutable post-selector364 PK ranking."""
...
SPEC = importlib.util.spec_from_file_location("post364_ranking_test", PATH)
...
class PostSelector364RankingTests(unittest.TestCase):
    @classmethod
    ...
    def test_exact_universe_recommendation_and_closure_guards(self) -> None:
        self.assertEqual(
            (
        ...
        self.assertEqual(
            ...
            ("0:1168", 48, 13, 14, 53, 58, 5, 0),
        )
        self.assertEqual(
            self.private["classification_counts"],
            {
                "already_owned_selector_or_dispatch_closure": 23,
                "eligible_fixed_seven_way_selector": 104,
        ...
        self.assertTrue({"0:508", "0:376", "0:364"}.isdisjoint(ranked))
