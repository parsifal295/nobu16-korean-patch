#!/usr/bin/env python3
"""Focused tests for the immutable two-chunk selector-742 assignment."""
...
PATH = Path(__file__).with_name("build_pk_selector742_assignment_v1.py")
SPEC = importlib.util.spec_from_file_location("selector742_assignment_test", PATH)
...
class Selector742AssignmentTests(unittest.TestCase):
    @classmethod
