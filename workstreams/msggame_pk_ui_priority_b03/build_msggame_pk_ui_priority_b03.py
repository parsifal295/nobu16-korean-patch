#!/usr/bin/env python3
"""Build source-free PK msggame UI-priority batch B03."""
...
BATCH_ID = "msggame_pk_ui_priority_b03_220.v1"
RESOURCE = "MSG_PK/SC/msggame.bin"
OVERLAY_NAME = "msggame_ko_pk_ui_priority_b03_220.v1.json"
EVIDENCE_NAME = "msggame_pk_ui_priority_b03_evidence.v1.json"
REVIEW_NAME = "msggame_pk_ui_priority_b03_review.v1.json"
VALIDATION_NAME = "msggame_pk_ui_priority_b03_validation.v1.json"
...
def build(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if any(coordinate[0] != 14 for coordinate in TRANSLATIONS):
        raise BatchError("B03 translation escaped static help/UI block 14")
    ...
    overlay = {
        ...
        "selection_policy": {
            "priority": "block14_short_static_help_menu_label_and_system_ui",
    ...
    evidence_entries = [
        {
            ...
            "record_id": item["coordinate"][1],
            "literal_id": item["coordinate"][2],
            "review_method": "switch_v13_reference_then_agent_pk_multilingual_ui_review",
    ...
    evidence = {
        ...
        "scope": {
            ...
            "selection": "short_static_help_menu_label_settings_battle_and_management_ui",
        },
        "target_catalog": {
    ...
    for item in selected:
        if full_literals[item["coordinate"]].text != item["replacement"]:
            raise BatchError(f"full candidate lost B03 replacement at {item['coordinate']}")
    ...
    validation = {
        ...
        "full_candidate_validation": {
            ...
            "b03_entry_count": full_manifest["entry_count"],
